...
[1] /applicant/new
URL::
curl -X POST -H 'Content-type: application/json' -d '{"first_name": "Nimi", "last_name": "Williams", "email": "nimiwilliams@gmail.com"}'  http://127.0.0.1:5000/kangaroo/v1/applicant/new
...
[3] /bp/profile/update
URL:: curl -X PUT -H 'Content-type: application/json' -d '{"email": "joshua123@gmail.com", "full_name": "A_VERY_LONG_NAME"}' http://localhost:5000/kangaroo/v1/bp/profile/update
