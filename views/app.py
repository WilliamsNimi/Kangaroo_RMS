...
"""
from flask import Flask, request, g, jsonify, abort, render_template, Blueprint
import backend_auth
from applicant.applicant import applicant_bp
from recruiter.recruiter import recruiter_bp
from business_partner.businesspartner import business_partner_bp
...
app.register_blueprint(business_partner_bp)
...
def home():
    """
    Home route
    jsonify({'success': True, 'message': 'Welcome to General Home!'})
    """
